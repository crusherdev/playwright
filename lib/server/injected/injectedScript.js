...
exports.default = exports.SelectorTypeEnum = exports.InjectedScript = void 0;
    ...
    const queryList = (root, encodedSelectors) => {
      try {
        ...
        for (const nonPlaywrightSelector of nonPlaywrightSelectors) {
          ...
          try {
            if (nonPlaywrightSelector.type === SelectorTypeEnum.XPATH) elements = getElementsByXPath(document.documentElement, nonPlaywrightSelector.value);else elements = this._evaluator._queryCSS({
              scope: root,
              pierceShadow: shadow
